package com.vaibhav.assignment73;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (db.checkDB()) { //default entry
            Bitmap photo = BitmapFactory.decodeResource(getResources(), R.drawable.vaibhav);
            byte photoBytes[] = getBytes(photo);
            Employee employee = new Employee("Vaibhav",60,photoBytes);
